            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2 max-w-md mx-auto">
                <input
                  ...
                  required
                  className="flex-1 px-4 py-3 bg-white/10 border border-white/10 rounded-lg text-sm text-cream placeholder-cream/40 focus:outline-none focus:border-gold/50 focus:ring-1 focus:ring-gold/30 transition-all"
                />
                <button
                  type="submit"
                  className="px-5 py-3 bg-gold hover:bg-gold-light text-foreground font-medium rounded-lg text-sm transition-colors flex items-center gap-2"
                >
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-cream/60 hover:bg-gold/20 hover:text-gold transition-all"
